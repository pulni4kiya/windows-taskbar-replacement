# Simple Windows Taskbar Replacement

This is a simple app that is meant to render on top of the default windows taskbar, specifically the middle part where the current running application are.
It allows you to organize the applications into groups for easier navigation. You can put apps in groups, define the order of groups, and even make some groups align to the right.

## Awesome features
- Put apps inside groups with customizable background colors
- Order groups and apps inside the groups as you please
- Align groups to the left or to the right
